...
**Gateway API** became generally available in OpenShift Service Mesh 2.6, supporting the Kubernetes Gateway API version 1.0.0. This functionality is exclusive to Red Hat OpenShift Service Mesh, and the Gateway API custom resource definitions (CRDs) are not supported outside this context.
...
link:https://docs.openshift.com/container-platform/4.17/service_mesh/v2x/servicemesh-release-notes.html#gateway-api-ga-cluster-wide-deployments-ossm-2-6-0_ossm-release-notes[Service Mesh Release Notes]
